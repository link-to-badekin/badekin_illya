...
from Bestimator.feature_extractor.FaceModel import FaceModel
...
class ResNet(Module):
	...
	def __init__(self, input_size, block, layers, zero_init_residual = True, fc_input_size=2048):
		...
		# улучшает модель на 0.2~0.3% https://arxiv.org/abs/1706.02677
...
class resnet(FaceModel):
	def __init__(self, input_size=(112, 112), depth=50, dataset='ms1m', **kwargs):
		if depth == 50:
			Net = ResNet_50(input_size)
			if dataset == 'ms1m':
				url = 'http://ml.cs.tsinghua.edu.cn/~dingcheng/ckpts/face_models/model13/Backbone_ResNet_50_Epoch_36_Batch_204696_Time_2019-04-14-14-44_checkpoint.pth'
				channel = 'bgr'
			else:
				url = 'http://ml.cs.tsinghua.edu.cn/~zihao/realai/ckpts/model16/Backbone_ResNet_50_Epoch_82_Batch_72406_Time_2019-04-28-20-57_checkpoint.pth'
				channel = 'rgb'
		FaceModel.__init__(
			self,
			url=url,
